"use strict";var gt=Object.create;var w=Object.defineProperty;var Tt=Object.getOwnPropertyDescriptor;var ht=Object.getOwnPropertyNames;var ft=Object.getPrototypeOf,bt=Object.prototype.hasOwnProperty;var Ot=(r,e)=>{for(var t in e)w(r,t,{get:e[t],enumerable:!0})},te=(r,e,t,s)=>{if(e&&typeof e=="object"||typeof e=="function")for(let n of ht(e))!bt.call(r,n)&&n!==t&&w(r,n,{get:()=>e[n],enumerable:!(s=Tt(e,n))||s.enumerable});return r};var A=(r,e,t)=>(t=r!=null?gt(ft(r)):{},te(e||!r||!r.__esModule?w(t,"default",{value:r,enumerable:!0}):t,r)),St=r=>te(w({},"__esModule",{value:!0}),r);var Ut={};Ot(Ut,{generateContext:()=>ee});module.exports=St(Ut);var mt=A(require("path"),1),_t=require("os"),Et=require("fs");var le=require("bun:sqlite");var b=require("path"),ae=require("os"),P=require("fs");var de=require("url");var I=require("fs"),U=require("path"),ne=require("os");var se="bugfix,feature,refactor,discovery,decision,change",re="how-it-works,why-it-exists,what-changed,problem-solution,gotcha,pattern,trade-off";var C=class{static DEFAULTS={CLAUDE_PILOT_MODEL:"haiku",CLAUDE_PILOT_CONTEXT_OBSERVATIONS:"50",CLAUDE_PILOT_WORKER_PORT:"41777",CLAUDE_PILOT_WORKER_HOST:"127.0.0.1",CLAUDE_PILOT_WORKER_BIND:"127.0.0.1",CLAUDE_PILOT_SKIP_TOOLS:"ListMcpResourcesTool,SlashCommand,Skill,TodoWrite,AskUserQuestion",CLAUDE_PILOT_DATA_DIR:(0,U.join)((0,ne.homedir)(),".pilot/memory"),CLAUDE_PILOT_LOG_LEVEL:"INFO",CLAUDE_PILOT_PYTHON_VERSION:"3.12",CLAUDE_CODE_PATH:"",CLAUDE_PILOT_CONTEXT_SHOW_READ_TOKENS:!1,CLAUDE_PILOT_CONTEXT_SHOW_WORK_TOKENS:!1,CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_AMOUNT:!1,CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_PERCENT:!1,CLAUDE_PILOT_CONTEXT_OBSERVATION_TYPES:se,CLAUDE_PILOT_CONTEXT_OBSERVATION_CONCEPTS:re,CLAUDE_PILOT_CONTEXT_FULL_COUNT:"10",CLAUDE_PILOT_CONTEXT_FULL_FIELD:"facts",CLAUDE_PILOT_CONTEXT_SESSION_COUNT:"10",CLAUDE_PILOT_CONTEXT_SHOW_LAST_SUMMARY:!0,CLAUDE_PILOT_CONTEXT_SHOW_LAST_MESSAGE:!0,CLAUDE_PILOT_FOLDER_CLAUDEMD_ENABLED:!1,CLAUDE_PILOT_FOLDER_MD_EXCLUDE:"[]",CLAUDE_PILOT_CHROMA_ENABLED:!0,CLAUDE_PILOT_VECTOR_DB:"chroma",CLAUDE_PILOT_EMBEDDING_MODEL:"Xenova/all-MiniLM-L6-v2",CLAUDE_PILOT_EXCLUDE_PROJECTS:"[]",CLAUDE_PILOT_REMOTE_TOKEN:"",CLAUDE_PILOT_RETENTION_ENABLED:!0,CLAUDE_PILOT_RETENTION_MAX_AGE_DAYS:"31",CLAUDE_PILOT_RETENTION_MAX_COUNT:"5000",CLAUDE_PILOT_RETENTION_EXCLUDE_TYPES:'["summary"]',CLAUDE_PILOT_RETENTION_SOFT_DELETE:!1,CLAUDE_PILOT_BATCH_SIZE:"5"};static getAllDefaults(){return{...this.DEFAULTS}}static get(e){return this.DEFAULTS[e]}static getInt(e){let t=this.get(e);return parseInt(t,10)}static getBool(e){return this.get(e)==="true"}static loadFromFile(e){try{if(!(0,I.existsSync)(e)){let a=this.getAllDefaults();try{let p=(0,U.dirname)(e);(0,I.existsSync)(p)||(0,I.mkdirSync)(p,{recursive:!0}),(0,I.writeFileSync)(e,JSON.stringify(a,null,2),"utf-8"),console.log("[SETTINGS] Created settings file with defaults:",e)}catch(p){console.warn("[SETTINGS] Failed to create settings file, using in-memory defaults:",e,p)}return a}let t=(0,I.readFileSync)(e,"utf-8"),s=JSON.parse(t),n=s;if(s.env&&typeof s.env=="object"){n=s.env;try{(0,I.writeFileSync)(e,JSON.stringify(n,null,2),"utf-8"),console.log("[SETTINGS] Migrated settings file from nested to flat schema:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate settings file:",e,a)}}let o=["CLAUDE_PILOT_CONTEXT_SHOW_READ_TOKENS","CLAUDE_PILOT_CONTEXT_SHOW_WORK_TOKENS","CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_AMOUNT","CLAUDE_PILOT_CONTEXT_SHOW_SAVINGS_PERCENT","CLAUDE_PILOT_CONTEXT_SHOW_LAST_SUMMARY","CLAUDE_PILOT_CONTEXT_SHOW_LAST_MESSAGE","CLAUDE_PILOT_FOLDER_CLAUDEMD_ENABLED","CLAUDE_PILOT_CHROMA_ENABLED","CLAUDE_PILOT_RETENTION_ENABLED","CLAUDE_PILOT_RETENTION_SOFT_DELETE"],i={...this.DEFAULTS},d=!1;for(let a of Object.keys(this.DEFAULTS))if(n[a]!==void 0)if(o.includes(a)){let p=n[a];typeof p=="string"?(i[a]=p==="true",d=!0):i[a]=p}else i[a]=n[a];if(d)try{(0,I.writeFileSync)(e,JSON.stringify(i,null,2),"utf-8"),console.log("[SETTINGS] Migrated boolean settings from strings to actual booleans:",e)}catch(a){console.warn("[SETTINGS] Failed to auto-migrate boolean settings:",e,a)}return i}catch(t){return console.warn("[SETTINGS] Failed to load settings, using defaults:",e,t),this.getAllDefaults()}}};var N=require("fs"),v=require("path"),ie=require("os"),B=(o=>(o[o.DEBUG=0]="DEBUG",o[o.INFO=1]="INFO",o[o.WARN=2]="WARN",o[o.ERROR=3]="ERROR",o[o.SILENT=4]="SILENT",o))(B||{}),oe=(0,v.join)((0,ie.homedir)(),".pilot/memory"),G=class{level=null;useColor;logFilePath=null;logFileInitialized=!1;constructor(){this.useColor=process.stdout.isTTY??!1}ensureLogFileInitialized(){if(!this.logFileInitialized){this.logFileInitialized=!0;try{let e=(0,v.join)(oe,"logs");(0,N.existsSync)(e)||(0,N.mkdirSync)(e,{recursive:!0});let t=new Date().toISOString().split("T")[0];this.logFilePath=(0,v.join)(e,`pilot-memory-${t}.log`)}catch(e){console.error("[LOGGER] Failed to initialize log file:",e),this.logFilePath=null}}}getLevel(){if(this.level===null)try{let e=(0,v.join)(oe,"settings.json");if((0,N.existsSync)(e)){let t=(0,N.readFileSync)(e,"utf-8"),n=(JSON.parse(t).CLAUDE_PILOT_LOG_LEVEL||"INFO").toUpperCase();this.level=B[n]??1}else this.level=1}catch{this.level=1}return this.level}correlationId(e,t){return`obs-${e}-${t}`}sessionId(e){return`session-${e}`}formatData(e){if(e==null)return"";if(typeof e=="string")return e;if(typeof e=="number"||typeof e=="boolean")return e.toString();if(typeof e=="object"){if(e instanceof Error)return this.getLevel()===0?`${e.message}
${e.stack}`:e.message;if(Array.isArray(e))return`[${e.length} items]`;let t=Object.keys(e);return t.length===0?"{}":t.length<=3?JSON.stringify(e):`{${t.length} keys: ${t.slice(0,3).join(", ")}...}`}return String(e)}formatTool(e,t){if(!t)return e;let s=t;if(typeof t=="string")try{s=JSON.parse(t)}catch{s=t}if(e==="Bash"&&s.command)return`${e}(${s.command})`;if(s.file_path)return`${e}(${s.file_path})`;if(s.notebook_path)return`${e}(${s.notebook_path})`;if(e==="Glob"&&s.pattern)return`${e}(${s.pattern})`;if(e==="Grep"&&s.pattern)return`${e}(${s.pattern})`;if(s.url)return`${e}(${s.url})`;if(s.query)return`${e}(${s.query})`;if(e==="Task"){if(s.subagent_type)return`${e}(${s.subagent_type})`;if(s.description)return`${e}(${s.description})`}return e==="Skill"&&s.skill?`${e}(${s.skill})`:e==="LSP"&&s.operation?`${e}(${s.operation})`:e}formatTimestamp(e){let t=e.getFullYear(),s=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0"),o=String(e.getHours()).padStart(2,"0"),i=String(e.getMinutes()).padStart(2,"0"),d=String(e.getSeconds()).padStart(2,"0"),a=String(e.getMilliseconds()).padStart(3,"0");return`${t}-${s}-${n} ${o}:${i}:${d}.${a}`}log(e,t,s,n,o){if(e<this.getLevel())return;this.ensureLogFileInitialized();let i=this.formatTimestamp(new Date),d=B[e].padEnd(5),a=t.padEnd(6),p="";n?.correlationId?p=`[${n.correlationId}] `:n?.sessionId&&(p=`[session-${n.sessionId}] `);let l="";o!=null&&(o instanceof Error?l=this.getLevel()===0?`
${o.message}
${o.stack}`:` ${o.message}`:this.getLevel()===0&&typeof o=="object"?l=`
`+JSON.stringify(o,null,2):l=" "+this.formatData(o));let m="";if(n){let{sessionId:E,memorySessionId:T,correlationId:O,..._}=n;Object.keys(_).length>0&&(m=` {${Object.entries(_).map(([h,y])=>`${h}=${y}`).join(", ")}}`)}let g=`[${i}] [${d}] [${a}] ${p}${s}${m}${l}`;if(this.logFilePath)try{(0,N.appendFileSync)(this.logFilePath,g+`
...
`)[2]||"").match(/at\s+(?:.*\s+)?\(?([^:]+):(\d+):(\d+)\)?/),l=p?`${p[1].split("/").pop()}:${p[2]}`:"unknown",m={...s,location:l};return this.warn(e,`[HAPPY-PATH] ${t}`,m,n),o}},u=new G;var Rt={};function yt(){return typeof __dirname<"u"?__dirname:(0,b.dirname)((0,de.fileURLToPath)(Rt.url))}var Bt=yt(),R=C.get("CLAUDE_PILOT_DATA_DIR"),D=process.env.CLAUDE_CONFIG_DIR||(0,b.join)((0,ae.homedir)(),".claude"),Gt=(0,b.join)(R,"archives"),Yt=(0,b.join)(R,"logs"),qt=(0,b.join)(R,"trash"),Vt=(0,b.join)(R,"backups"),Kt=(0,b.join)(R,"modes"),Jt=(0,b.join)(R,"settings.json"),ce=(0,b.join)(R,"pilot-memory.db"),zt=(0,b.join)(R,"vector-db"),Qt=(0,b.join)(D,"settings.json"),Zt=(0,b.join)(D,"commands"),es=(0,b.join)(D,"CLAUDE.md"),ts=(0,b.join)(D,".credentials.json"),It=(0,b.join)(D,"plugins"),ss=(0,b.join)(It,"marketplaces","pilot");function pe(r){(0,P.mkdirSync)(r,{recursive:!0})}var $=class{db;constructor(e=ce){e!==":memory:"&&pe(R),this.db=new le.Database(e),this.db.run("PRAGMA journal_mode = WAL"),this.db.run("PRAGMA synchronous = NORMAL"),this.db.run("PRAGMA foreign_keys = ON"),this.initializeSchema(),this.ensureWorkerPortColumn(),this.ensurePromptTrackingColumns(),this.removeSessionSummariesUniqueConstraint(),this.addObservationHierarchicalFields(),this.makeObservationsTextNullable(),this.createUserPromptsTable(),this.ensureDiscoveryTokensColumn(),this.createPendingMessagesTable(),this.renameSessionIdColumns(),this.repairSessionIdColumnRename(),this.addFailedAtEpochColumn(),this.ensureSessionPlansTable(),this.createProjectRootsTable()}initializeSchema(){this.db.run(`
...
Do not output anything other than the summary content formatted in the XML structure above.`}},S=class r{static instance=null;activeMode=null;constructor(){}static getInstance(){return r.instance||(r.instance=new r),r.instance}loadMode(){return this.activeMode=Te,Te}getActiveMode(){if(!this.activeMode)throw new Error("No mode loaded. Call loadMode() first.");return this.activeMode}getObservationTypes(){return this.getActiveMode().observation_types}getObservationConcepts(){return this.getActiveMode().observation_concepts}getTypeIcon(e){return this.getObservationTypes().find(s=>s.id===e)?.emoji||"\u{1F4DD}"}getWorkEmoji(e){return this.getObservationTypes().find(s=>s.id===e)?.work_emoji||"\u{1F4DD}"}validateType(e){return this.getObservationTypes().some(t=>t.id===e)}getTypeLabel(e){return this.getObservationTypes().find(s=>s.id===e)?.label||e}};function q(r){let e=(r.title?.length||0)+(r.subtitle?.length||0)+(r.narrative?.length||0)+JSON.stringify(r.facts||[]).length;return Math.ceil(e/ge)}function V(r){let e=r.length,t=r.reduce((i,d)=>i+q(d),0),s=r.reduce((i,d)=>i+(d.discovery_tokens||0),0),n=s-t,o=s>0?Math.round(n/s*100):0;return{totalObservations:e,totalReadTokens:t,totalDiscoveryTokens:s,savings:n,savingsPercent:o}}function Nt(r){return S.getInstance().getWorkEmoji(r)}function L(r,e){let t=q(r),s=r.discovery_tokens||0,n=Nt(r.type),o=s>0?`${n} ${s.toLocaleString()}`:"-";return{readTokens:t,discoveryTokens:s,discoveryDisplay:o,workEmoji:n}}function F(r){return r.showReadTokens||r.showWorkTokens||r.showSavingsAmount||r.showSavingsPercent}var he=A(require("path"),1),fe=require("os"),j=require("fs");function K(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,...s,...o,t.totalObservationCount)}function J(r,e,t){return r.db.prepare(`
    SELECT id, memory_session_id, request, investigated, learned, completed, next_steps, created_at, created_at_epoch
    FROM session_summaries
    WHERE project = ?
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(e,t.sessionCount+x)}function be(r,e,t){let s=Array.from(t.observationTypes),n=s.map(()=>"?").join(","),o=Array.from(t.observationConcepts),i=o.map(()=>"?").join(","),d=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      id, memory_session_id, type, title, subtitle, narrative,
      facts, concepts, files_read, files_modified, discovery_tokens,
  ...
  `).all(...e,...s,...o,t.totalObservationCount)}function Oe(r,e,t){let s=e.map(()=>"?").join(",");return r.db.prepare(`
    ...
    ORDER BY created_at_epoch DESC
    LIMIT ?
  `).all(...e,t.sessionCount+x)}function Se(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),d=i.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
  ...
  `).all(e,...n,...i,s,t.totalObservationCount)}function ye(r,e,t,s){return r.db.prepare(`
    ...
    LIMIT ?
  `).all(e,s,t.sessionCount+x)}function Ie(r,e,t,s){let n=Array.from(t.observationTypes),o=n.map(()=>"?").join(","),i=Array.from(t.observationConcepts),d=i.map(()=>"?").join(","),a=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT
      o.id, o.memory_session_id, o.type, o.title, o.subtitle, o.narrative,
      o.facts, o.concepts, o.files_read, o.files_modified, o.discovery_tokens,
    ...
    ORDER BY o.created_at_epoch DESC
    LIMIT ?
  `).all(...e,...n,...i,s,t.totalObservationCount)}function Re(r,e,t,s){let n=e.map(()=>"?").join(",");return r.db.prepare(`
    SELECT ss.id, ss.memory_session_id, ss.request, ss.investigated, ss.learned,
...
`}function st(r,e,t,s){let n=[];return s?n.push(...He(r)):n.push(...Ae(r)),s?n.push(...Be()):n.push(...ve()),s?n.push(...Ge()):n.push(...De()),s?n.push(...Ye()):n.push(...xe()),F(t)&&(s?n.push(...qe(e,t)):n.push(...Me(e,t))),n}var Z=A(require("path"),1);function H(r){if(!r)return[];try{let e=JSON.parse(r);return Array.isArray(e)?e:[]}catch(e){return u.debug("PARSER","Failed to parse JSON array, using empty fallback",{preview:r?.substring(0,50)},e),[]}}function nt(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",hour:"numeric",minute:"2-digit",hour12:!0})}function ot(r){return new Date(r).toLocaleString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0})}function it(r){return new Date(r).toLocaleString("en-US",{month:"short",day:"numeric",year:"numeric"})}function rt(r,e){return Z.default.isAbsolute(r)?Z.default.relative(e,r):r}function at(r,e,t){let s=H(r);if(s.length>0)return rt(s[0],e);if(t){let n=H(t);if(n.length>0)return rt(n[0],e)}return"General"}function At(r){let e=new Map;for(let s of r){let n=s.type==="observation"?s.data.created_at:s.data.displayTime,o=it(n);e.has(o)||e.set(o,[]),e.get(o).push(s)}let t=Array.from(e.entries()).sort((s,n)=>{let o=new Date(s[0]).getTime(),i=new Date(n[0]).getTime();return o-i});return new Map(t)}function vt(r,e){return e.fullObservationField==="narrative"?r.narrative:r.facts?H(r.facts).join(`
`):null}function Dt(r,e,t,s,n,o){let i=[];o?i.push(...Ve(r)):i.push(...ke(r));let d=null,a="",p=!1;for(let l of e)if(l.type==="summary"){p&&(i.push(""),p=!1,d=null,a="");let m=l.data,g=nt(m.displayTime);o?i.push(...Qe(m,g)):i.push(...$e(m,g))}else{let m=l.data,g=at(m.files_modified,n,m.files_read),E=ot(m.created_at),T=E!==a,O=T?E:"";a=E;let _=t.has(m.id);if(g!==d&&(p&&i.push(""),o?i.push(...Ke(g)):i.push(...we(g)),d=g,p=!0),_){let f=vt(m,s);o?i.push(...ze(m,E,T,f,s)):(p&&!o&&(i.push(""),p=!1),i.push(...Pe(m,O,f,s)),d=null)}else o?i.push(Je(m,E,T,s)):i.push(Ue(m,O,s))}return p&&i.push(""),i}function dt(r,e,t,s,n){let o=[],i=At(r);for(let[d,a]of i)o.push(...Dt(d,a,e,t,s,n));return o}function ct(r,e,t){return!(!r.showLastSummary||!e||!!!(e.investigated||e.learned||e.completed||e.next_steps)||t&&e.created_at_epoch<=t.created_at_epoch)}function pt(r,e){let t=[];return e?(t.push(...k("Investigated",r.investigated,c.blue)),t.push(...k("Learned",r.learned,c.yellow)),t.push(...k("Completed",r.completed,c.green)),t.push(...k("Next Steps",r.next_steps,c.magenta))):(t.push(...M("Investigated",r.investigated)),t.push(...M("Learned",r.learned)),t.push(...M("Completed",r.completed)),t.push(...M("Next Steps",r.next_steps))),t}function lt(r,e){return e?Ze(r):Fe(r)}function ut(r,e,t){return!F(e)||r.totalDiscoveryTokens<=0||r.savings<=0?[]:t?et(r.totalDiscoveryTokens,r.totalReadTokens):je(r.totalDiscoveryTokens,r.totalReadTokens)}var xt=mt.default.join((0,_t.homedir)(),".claude","plugins","marketplaces","pilot","plugin",".install-version");function Mt(){try{return new $}catch(r){if(r.code==="ERR_DLOPEN_FAILED"){try{(0,Et.unlinkSync)(xt)}catch(e){u.debug("SYSTEM","Marker file cleanup failed (may not exist)",{},e)}return u.error("SYSTEM","Native module rebuild needed - restart Claude Code to auto-fix"),null}throw r}}function kt(r,e){return e?tt(r):Xe(r)}function wt(r,e,t,s,n,o,i){let d=[],a=V(e);d.push(...st(r,a,s,i));let p=t.slice(0,s.sessionCount),l=Ne(p,t),m=Q(e,l),g=Ce(e,s.fullObservationCount);d.push(...dt(m,g,s,n,i));let E=t[0],T=e[0];ct(s,E,T)&&d.push(...pt(E,i));let O=z(e,s,o,n);return d.push(...lt(O,i)),d.push(...ut(a,s,i)),d.join(`
`).trimEnd()}async function ee(r,e=!1){let t=Y(),s=r?.cwd??process.cwd(),n=me(s),o=r?.projects||[n],i=Mt();if(!i)return"";try{let d=r?.planPath,a,p;return d?(a=o.length>1?Ie(i,o,t,d):Se(i,n,t,d),p=o.length>1?Re(i,o,t,d):ye(i,n,t,d)):(a=o.length>1?be(i,o,t):K(i,n,t),p=o.length>1?Oe(i,o,t):J(i,n,t)),a.length===0&&p.length===0?kt(n,e):wt(n,a,p,t,s,r?.session_id,e)}finally{i.close()}}0&&(module.exports={generateContext});
